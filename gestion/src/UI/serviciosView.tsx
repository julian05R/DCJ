...
const servicios = [
  { id: 1, icon: Users, title: "Atracción y Retención del Talento Humano" },
  {
    id: 2,
    icon: ClipboardList,
    title:
      "Asesoría en la Administración y Procesos del Área de Talento Humano",
  },
  {
    id: 3,
    icon: GraduationCap,
  ...
  { id: 4, icon: Gift, title: "Plan de Beneficios y Bienestar" },
  {
    id: 5,
    icon: BarChart2,
    title: "Medición para la Eficiencia del Talento Humano",
  },
  { id: 6, icon: Scale, title: "Marco Legal" },
  { id: 7, icon: Shield, title: "Seguridad y Salud en el Trabajo" },
  {
    id: 8,
    icon: Camera,
    title: "Seguridad Física y Electrónica en las Organizaciones",
  },
  { id: 9, icon: Award, title: "Sistema de Gestión de Calidad" },
];
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {servicios.map((servicio, index) => (
            <Link key={index} href={`/servicios?id=${servicio.id}`}>
              <div className="bg-white rounded-2xl shadow-sm border border-[#4FA58D]/10 p-6 flex items-start gap-4 hover:shadow-xl hover:shadow-[#4FA58D]/10 hover:scale-105 hover:border-[#4FA58D]/40 transition-all duration-300 group cursor-pointer">
                {/* NÚMERO */}
