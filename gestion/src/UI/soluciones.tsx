...
const solucionesItems = [
  {
    ...
    Items: [
      ...
      "Onboarding (acompañamiento en la inducción)",
      "Assessment center",
      "Estudios de seguridad",
      "Visitas domiciliarias",
      "Informe final de selección",
      "Asesoría en diseño de perfiles de cargo",
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "Diseñamos, asesoramos e implementamos el Sistema de Gestión de Seguridad y Salud en el Trabajo en todas las etapas del ciclo PHVA, utilizando metodologías prácticas y comprensibles para los colaboradores involucrados. De esta manera, garantizamos el cumplimiento de los lineamientos establecidos en la normativa vigente (Decreto 1072 de 2015 y Resolución 0312 de 2019).",
    Items: [
      {
        grupo: "PLANIFICACIÓN",
        subItems: [
      ...
      },
      {
        ...
        subItems: [
          ...
          "Programas de intervención del riesgo y PVE",
          "Gestión de accidentes e incidentes",
          "Conformación de COPASST y Comité de Convivencia laboral",
          "Aplicación de la batería de riesgo psicosocial",
          "Programas de riesgo psicosocial",
          "Elaboración del plan formacióne inducción",
        ],
      },
      {
        grupo: "AUDITORÍA Y REVISIÓN",
        subItems: [
          "Auditoria del SG-SST",
          "Indicadores de estructura, proceso y resultado",
          "Elaboración de informes técnicos y diseño de   planes de intervención efectivos, orientados a   proteger la salud mental y el bienestar de los colaboradores, fortaleciendo así la productividad  y el clima organizacional",
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="text-center mb-14 flex flex-col items-center gap-3">
          ...
          <h1 className="text-4xl font-bold text-[#2E2E2E]">
            NUESTRAS
            <span className="text-[#4FA58D] relative px-1">
              SOLUCIONES
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl shadow-sm border transition-all duration-300 overflow-hidden ${
                  estaActivo
                    ? "border-[#4FA58D] shadow-lg shadow-[#4FA58D]/10"
                    : "border-[#4FA58D]/10 hover:border-[#4FA58D]/40"
                }`}
              >
                <button
                ...
                >
                  <div
                    className={`shrink-0 w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 ${
                      estaActivo
                        ? "bg-[#4FA58D] shadow-lg shadow-[#4FA58D]/30"
                        : "bg-[#4FA58D]/10 group-hover:bg-[#4FA58D]"
                    }`}
                  >
                    <Icon
                      size={22}
                      className={`transition-colors duration-300 ${estaActivo ? "text-white" : "text-[#4FA58D] group-hover:text-white"}`}
                    />
                  </div>
                  <div className="flex-1">
                    <div
                      className={`w-8 h-0.5 rounded-full mb-1 transition-all duration-300 ${estaActivo ? "bg-[#4FA58D] w-16" : "bg-[#4FA58D]/30"}`}
                    />
                    <p
                      className={`font-bold text-sm leading-snug transition-colors duration-300 ${estaActivo ? "text-[#4FA58D]" : "text-[#2E2E2E]"}`}
                    >
                      {item.title}
                    </p>
                  </div>
                ...
                {estaActivo && (
                  <div className="px-6 pb-6 border-t border-[#4FA58D]/10">
                    ...
                    "grupo" in item.Items[0] ? (
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                        {(
                          item.Items as { grupo: string; subItems: string[] }[]
                        ).map((g, i) => (
                          <div key={i} className="bg-[#f0faf6] rounded-xl p-4">
                            <p className="text-xs font-bold text-[#4FA58D] mb-2 tracking-wide">
                              {g.grupo}
                            </p>
